...
// ── zip extraction (thin wrappers for test compatibility) ─────────────────

// readPackageFromRequest delegates to the shared packageupload helper.
func readPackageFromRequest(r *http.Request) ([]packagekit.PackageEntry, error) {
	return packageupload.ReadPackageFromRequest(r)
}

// extractZip delegates to the shared packageupload helper.  Exported for
// backward compatibility with existing tests in this package.
